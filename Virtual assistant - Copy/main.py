...
def respond(voice_data):
   ...
   # 2: name
    ...
    #15 command prompt
    if there_exists(["command prompt","open command prompt","open cmd","cmd"]):
        os.system("start cmd")
        engine_speak("it is open")
    #16 opening camera
    if there_exists(["open the camera","open the webcam","camera","wencam","open camera","open webcam"]):
    ...
    if there_exists(['volume down','lower the volume','decrease volume']):
        pyautogui.press("volumedown")
    if there_exists(['mute','silence']):
        ...
        while(1):
          ...
          if there_exists(["wake up","trinity"],self.voice_data):
            ...
            while (1):
                ...
                if there_exists(["sleep","rest"],self.voice_data):
